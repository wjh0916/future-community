            ...
            <div class="topBarInfo">
              ...
              <div>
                <div>
                  ...
                  <div style="display: inline-block"><Button style="margin-right: 10px" type="info" v-for="(item, index) in cateGory" :key="index">{{item}}</Button></div>
                </div>
                <p>评论数：{{info.chat}}</p>
                <p>阅读量：{{info.eye}}</p>
              </div>
