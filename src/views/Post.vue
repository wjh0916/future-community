        ...
        <div class="main">
          <div class="mainLeft">
            ...
            >
              ...
              <FormItem>
                <Button type="primary" @click="handleSubmit('newTopic')" long
                  >发布新话题</Button
                >
              </FormItem>
            </Form>
          ...
          <div class="mainRight">
            ...
            <div class="textOutline" v-show="newTopic.outline !== ''">
              简介：{{ newTopic.outline }}
            </div>
    ...
    handleSubmit(name) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          list.cid = cid;
          this.$artApi.post(list).then((result) => {
            if (result.ret === 200) {
              this.$router.push("/");
